...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1Tm8QeZE4a?p=74)
...
第四章：这个章节主要绘制出了系统功能架构，让我们更直观了解儿童教育网站的功能，对后台数据库表进行了设计，还画出了对应的Ｅ－Ｒ图。
...
![文章留言](/md/blog.009.jpeg "文章留言")
图4.2 文章留言实体属性图

（3）下图是文章目录实体和其具备的属性。

![文章目录](/md/blog.010.jpeg "文章目录")
图4.3 文章目录实体属性图

（4）下图是文章目录收藏实体和其具备的属性。

![文章目录收藏](/md/blog.011.jpeg "文章目录收藏")
图4.4 文章目录收藏实体属性图

（5）下图是章节收藏实体和其具备的属性。

![章节收藏](/md/blog.012.jpeg "章节收藏")
图4.5 章节收藏实体属性图

（6）下图是章节实体和其具备的属性。

![章节](/md/blog.013.jpeg "章节")
图4.6 章节实体属性图

（7）下图是视频收藏实体和其具备的属性。

![视频收藏](/md/blog.014.jpeg "视频收藏")
图4.7 视频收藏实体属性图

（8）下图是名师实体和其具备的属性。

![名师](/md/blog.015.jpeg "名师")
图4.8 名师实体属性图

（9）下图是文章收藏实体和其具备的属性。

![文章收藏](/md/blog.016.jpeg "文章收藏")
图4.9 文章收藏实体属性图

（10）下图是文章实体和其具备的属性。

![文章](/md/blog.017.jpeg "文章")
图4.10 文章实体属性图

（11）下图是视频实体和其具备的属性。

![视频](/md/blog.018.jpeg "视频")
图4.11 视频实体属性图

（12）下图是视频留言实体和其具备的属性。

![视频留言](/md/blog.019.jpeg "视频留言")
图4.12 视频留言实体属性图
...
|1|Id|Int|id|否|
|2|shipin\_id|Integer|视频|是|
|3|shipin\_zhangjie\_name|String|章节名称|是|
|4|shipin\_zhangjie\_photo|String|章节照片|是|
|5|shipin\_zhangjie\_video|String|章节视频|是|
|6|shipin\_zhangjie\_content|String|章节介绍|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shipin\_zhangjie\_id|Integer|章节|是|
|3|yonghu\_id|Integer|用户|是|
|4|shipin\_zhangjie\_collection\_types|Integer|类型|是|
|5|insert\_time|Date|收藏时间|是|
|6|create\_time|Date|创建时间|是|
表4.8文章表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|wenzhang\_uuid\_number|String|文章编号|是|
|3|wenzhang\_name|String|文章名称|是|
|4|wenzhang\_photo|String|文章照片|是|
|5|wenzhang\_types|Integer|文章类型|是|
|6|zan\_number|Integer|赞|是|
|7|cai\_number|Integer|踩|是|
|8|vipwenzhang\_types|Integer|是否vip文章|是|
|9|nianlingduan\_types|Integer|适合年龄段|是|
|10|wenzhang\_content|String|文章介绍|是|
|11|shangxia\_types|Integer|是否上架|是|
|12|wenzhang\_delete|Integer|逻辑删除|是|
|13|create\_time|Date|创建时间|是|
表4.9文章收藏表
...
|1|Id|Int|id|否|
|2|wenzhang\_id|Integer|文章|是|
|3|wenzhang\_mulu\_name|String|文章目录名称|是|
|4|wenzhang\_mulu\_photo|String|文章目录照片|是|
|5|wenzhang\_mulu\_content|String|内容|是|
|6|create\_time|Date|创建时间|是|
表4.12文章目录收藏表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|wenzhang\_mulu\_id|Integer|文章目录|是|
|3|yonghu\_id|Integer|用户|是|
|4|wenzhang\_mulu\_collection\_types|Integer|类型|是|
|5|insert\_time|Date|收藏时间|是|
|6|create\_time|Date|创建时间|是|
表4.13用户表
